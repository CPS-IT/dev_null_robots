...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_devnullrobots_crawlercfg');
...
$TCA['tx_devnullrobots_crawlercfg'] = array (
	'ctrl' => array (
		...
		'iconfile'          => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY).'icon_tx_devnullrobots_crawlercfg.gif',
	),
);
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addToAllTCAtypes('sys_domain','tx_devnullrobots_crawler;;;;1-1-1, tx_devnullrobots_default, tx_devnullrobots_sitemap');

\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addToAllTCAtypes('pages','tx_devnullrobots_flags;;;;1-1-1', '', 'before:abstract');
?>